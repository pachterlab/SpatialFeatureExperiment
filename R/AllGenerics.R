...
#' @export
setGeneric("dimGeometry",
           function(x, type, MARGIN, sample_id = NULL,
                                   withDimnames=TRUE)
             standardGeneric("dimGeometry"))

#' @export
setGeneric("dimGeometry<-", function(x, type, MARGIN, sample_id = NULL,
                                     withDimnames=TRUE, translate = TRUE,...,
                                     value) standardGeneric("dimGeometry<-"))

#' @export
setGeneric("dimGeometryNames",
...
#' @export
setGeneric("annotGeometry",
           function(x, type, sample_id = NULL) standardGeneric("annotGeometry"))

#' @export
setGeneric("annotGeometry<-",
           function(x, type, sample_id = NULL, translate = TRUE, ..., value) standardGeneric("annotGeometry<-"))

#' @export
setGeneric("annotGeometryNames",
...
#' @export
setGeneric("annotGeometries<-",
           function(x, translate = TRUE,..., value)
             standardGeneric("annotGeometries<-"))

# Coercion--------
#' @export
setGeneric("toSpatialFeatureExperiment",
           function(x, ...) standardGeneric("toSpatialFeatureExperiment"))

# Spatial graphs--------
#' @export
setGeneric("spatialGraphs",
           function(x, MARGIN, sample_id = NULL, name)
             standardGeneric("spatialGraphs"))

#' @export
setGeneric("spatialGraphs<-",
           function(x, MARGIN, sample_id = NULL, name, value)
             standardGeneric("spatialGraphs<-"))

#' @export
setGeneric("colGraphs",
           function(x, sample_id = NULL, name) standardGeneric("colGraphs"))

#' @export
setGeneric("colGraphs<-",
           function(x, sample_id = NULL, name, value)
             standardGeneric("colGraphs<-"))

#' @export
setGeneric("rowGraphs",
           function(x, sample_id = NULL, name) standardGeneric("rowGraphs"))

#' @export
setGeneric("rowGraphs<-",
           function(x, sample_id = NULL, name, value)
             standardGeneric("rowGraphs<-"))

#' @export
setGeneric("annotGraphs",
           function(x, sample_id = NULL, name) standardGeneric("annotGraphs"))

#' @export
setGeneric("annotGraphs<-",
           function(x, sample_id = NULL, name, value)
             standardGeneric("annotGraphs<-"))

#' @export
setGeneric("spatialGraph",
           function(x, type, MARGIN, sample_id = NULL)
...
#' @export
setGeneric("findSpatialNeighbors",
...
# Local results--------------
#' @export
setGeneric("localResults",
           function(x, sample_id = NULL, name, features = NULL,
                    colGeometryName = NULL, annotGeometryName = NULL,
                    withDimnames = TRUE, ...) standardGeneric("localResults"))
