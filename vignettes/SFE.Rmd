...
```{r, echo=FALSE, out.width = "100%", fig.cap="Schematics of the SFE object"}
# Burning question: Alt text
...
## Geometries
### Column and row
Column and row geometries can be get or set with the `dimGeometries` or `dimGeometry` function. `dimGeometries` gets or sets all geometry of the given margin.
```{r}
