...
This package wraps functions in the `spdep` package to find spatial neighborhood graphs.
```{r}
...
```{r}
# Set graph by name
spatialGraph(sfe, "graph1", MARGIN = 2L) <- g
# Or equivalently
...
Use the `crop` function to directly get the subsetted SFE object.
```{r}
# Before
