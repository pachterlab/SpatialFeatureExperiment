...
Note that as of April 2026, `Seurat::SpatialFeaturePlot` has an error regarding [`UpdateSeuratObject`](https://github.com/satijalab/seurat/issues/10261). This problem is resolved in version `5.4.0.9002`, which does not seem to on CRAN yet as of writing. Use `pak::pak("satijalab/seurat")` to install this version.
