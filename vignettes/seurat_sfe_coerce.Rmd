...
ggplot() &
    ...
    #geom_sf(data = rowGeometry(sfe_conv_xen, "txSpots"), size = 0.5)
...
plotSpatialFeature(sfe_conv_vz, exprs_values = "counts",
                   ...
                   dark = TRUE,
                   #sample_id = "",
                   scattermore = F # will plot only centroids!
                  )
```
...
## TODO: Test when Seurat object has > 1 Assay - Vizgen
eg including SCT Assays
```{r}
...
## TODO: Test when multiple samples/FOVs and > 1 Assays are present in Seurat object
```{r}
