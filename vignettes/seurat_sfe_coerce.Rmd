...
```{r}
obj_vis2 <- readRDS(file.path(dir_root, "inst/extdata/seu_anterior1_visium.rds"))
obj_vis2
# plot it
...
```{r}
obj_vz_multi <- readRDS(file.path(dir_extdata, "seu_vz_toy_multi.rds")) # Vizgen
obj_vz_multi
obj_xen_multi <- readRDS(file.path(dir_extdata, "seu_xen_toy_multi.rds")) # Xenium
obj_xen_multi
obj_vis_multi <- readRDS(file.path(dir_extdata, "seu_vis_toy_multi.rds")) # Visium
obj_vis_multi
obj_vishd_multi <- readRDS(file.path(dir_extdata, "seu_vishd_multi.rds")) # Visium HD
obj_vishd_multi
```

## TODO: Convert multiple samples/FOVs - Visium
...
## TODO: Convert multiple samples/FOVs - Vizgen
```{r}
sfe_vz_multi <-
